Erp::Thichladi::Engine.routes.draw do
  ...
  get "dat-tour.html" => "frontend/tour#booking", as: :tour_booking
  post "dat-tour.html" => "frontend/tour#booking"
  get "tim_kiem.html" => "frontend/tour#tour_search", as: :tour_search
  get "dat-tour/thanh-cong.html" => "frontend/tour#thank_you", as: :tour_thankyou
